...
<main class="main-content position-relative border-radius-lg ">
          ...
          <form id="formCari" action="/dataZakat" method="GET">
            ...
            <div class="input-group">
              <div class="me-3">
                ...
                <input type="date" class="form-control" id="tanggalCari" oninput="tanggal()" name="searchZakat" value="{{ request('searchZakat') }}">
              </div>
              <div class="">

                <input type="date" class="form-control" id="tanggalCari2" name="searchZakat2" oninput="tanggal()" value="{{ request('searchZakat2') }}">
              </div>
            </div>
  ...
  <div class="container-fluid py-4">
      ...
      <div class="col-12">
        <div class="card mb-4">
          ...
          <div class="card-header pb-0">
            <h6 class="text-center">Data Zakat</h6>
            
            <div class="d-flex justify-content-end">

            <a class="btn btn-dark me-2" data-bs-toggle="modal" onclick="hitung()" data-bs-target="#modalZakat">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-middle text-center text-sm">
                      <span class="badge badge-sm "><a  href=""  data-bs-toggle="modal" onclick="zakatEdit({{$k}})"  data-bs-target="#modalEditZakat"><i class="bi bi-pencil-square"></i></a></span>
                    </td>
                    <td class="align-middle text-center text-sm">
    ...
    @include('component.modal.modalZakat')
    @include('component.modal.modalEditZakat')
...
function zakatEdit(data){
  console.log(data)
  document.getElementById('nominalZakatEdit').value = data.nominal ; 
  document.getElementById('tanggalZakatEdit').value = data.tanggal ; 
    document.getElementById('formEditZakat').action = '/editZakat/'+data.id ; 

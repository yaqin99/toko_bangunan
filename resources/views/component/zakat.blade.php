  ...
  <div class="container-fluid py-4">
    ...
    <div class="row">
                  ...
                  <td>
                    <div class="d-flex px-2 py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <a href="/detailTransaksi/{{ $sari->id }}"><h4 class="mb-0 text-sm">{{ $loop->index + 1  }}</h4></a>
                      </div>
                    </div>
                  </td>
                  <td class="align-middle text-center">
                    <span class="text-secondary text-xs font-weight-bold">Rp.{{ @number_format($sari->nominal,2,",",".")}}</span>
                  </td>
                  <td>
      ...
      <div class="col-md-4 mt-4">
        <form  method="POST" action="/addPenjualan/">
          @csrf
        ...
        <div class="card h-100 mb-4">
          ...
          <div class="card-body pt-4 p-3">
              ...
              <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
                  <div class="d-flex flex-column">
                    <h6 class="mb-1 text-dark text-sm">barang x harga</h6>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="d-flex justify-content-end">
                  <h6 class="mb-0 fw-lighter">Total Rp.</h6>
                </div>
              </div>
